...
class Edit_Without_Gradient:
    ...
    def gen_util_gradient_text(self, current_prompt, current_prompt_score, k_list_string=None, real_time_para_momentum=[]):
        ...
        if k_list_string is None and len(real_time_para_momentum) == 0:
            meta_util_gradient_text = (
                "Your task is to modify the current prompt to replace <Prompt>.\n\n"
                ...
                "Modify the current prompt and get a new improved prompt to replace <Prompt>"
                f" {instruction_pos_description} in the task examples.\n"
                "Wrap the modified prompt with <START> and <END>."
            )
            ...
            meta_util_gradient_text = (
                ...
                " modify the current prompt, and get a new improved prompt"
